...
public class Color {
    ...
    // Returns the closest color to the one he just captured (Returns either the line "LINE",
    // or the background "BACKGROUND" or OTHER if the captured color is very far from the two previous ones)
    public static String getTheClosestColor
    (float[] _sample, Color _lineColor, Color _backgroundColor, Color _medianColor,  double _MAXIMUM_TOLERATED_DISTANCE) throws NullPointerException {
        ...
        System.out.println("\n\tdistance_Sample_line == " + distance_Sample_line);
        System.out.println("\tdistance_Sample_background == " + distance_Sample_background);
        System.out.println("\tdistance_Sample_median == " + distance_Sample_median);
        ...
        if(min < _MAXIMUM_TOLERATED_DISTANCE){
            if(min == distance_Sample_line) {
                ...
                System.out.println("\n\t the closest is BACKGROUND ");
                return "BACKGROUND";
            }
            else {
                System.out.println("\n\t the closest is FRONTIER ");
                return "FRONTIER";
            }
        }
        else {
            System.out.println("\n\t the closest is OTHER ");
            return "OTHER";
        }
//        if (distance <= _MAXIMUM_TOLERATED_DISTANCE) {
//
...
//            distance = Color.getDistance(_sample, _backgroundColor.getRgbValues());
//            if (distance < _MAXIMUM_TOLERATED_DISTANCE) {
//
